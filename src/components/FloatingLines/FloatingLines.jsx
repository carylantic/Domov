...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  // zníženie jasu + mierna gamma
col *= 0.6;                 // HLAVNÉ stlmenie
col = clamp(col, 0.0, 1.0);
col = pow(col, vec3(1.1));  // jemná gamma, nič agresívne
...
linesGradient,
  enabledWaves = ['middle'],        // len stredná vlna, minimum výpočtov
  lineCount = [3],                  // veľmi málo línií
  lineDistance = [3],               // riadky vzdialené, menej výpočtov
  topWavePosition,
  middleWavePosition,
  bottomWavePosition = { x: 1.5, y: -0.5, rotate: 0 }, // jednoduchá poloha
  animationSpeed = 0.4,             // spomalene, menej stresu na GPU
  interactive = true,
  bendRadius = 3.0,                 // minimálny dosah ohybu
  bendStrength = -0.2,              // jemný ohyb pri myši
  mouseDamping = 0.1,               // miernejšie plynulé pohyby
  parallax = true,
  parallaxStrength = 0.05,          // minimum parallax
  mixBlendMode = 'screen'
}) {
